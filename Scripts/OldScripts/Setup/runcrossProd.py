...
for aws_account in textFile.split('\n'):
	...
	#Create Polciy
	command1="aws iam create-policy --policy-name ReadOnly --policy-document file://readaccountsPolicyProd.json --profile %s" %profile

	os.system (command1)

# Create Role
	command2= "aws iam create-role --role-name CrossAccountReader --assume-role-policy-document file://CCATrustPolicyProd.json --profile %s" %profile
	os.system (command2)
